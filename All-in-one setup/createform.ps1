...
#Global variable #5 >> AzureMailSuffix
$tmpName = @'
SharePointAdminUser
'@ 
$tmpValue = ""
...
'@ 
$tmpModel = @'
[{"key":"mail","type":0},{"key":"description","type":0},{"key":"mailNickname","type":0},{"key":"displayName","type":0}]
'@ 
$tmpInput = @'
